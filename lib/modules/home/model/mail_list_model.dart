class MailListModel {
  ...
  String id;
  String type;
  List<MailDetails> hydraMember;
  int hydraTotalItems;

  factory MailListModel.fromJson(Map<String, dynamic> json) => MailListModel(
        context: json["@context"],
        id: json["@id"],
        type: json["@type"],
        hydraMember: List<MailDetails>.from(
            json["hydra:member"].map((x) => MailDetails.fromJson(x))),
